...
namespace Ewan.Infrastructure.Data.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ClientPasswordResetTokens",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientPasswordResetTokens", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompromisedReason = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientPasswordResetTokens_ClientId_IsUsed_ExpiresAt",
                table: "ClientPasswordResetTokens",
                columns: new[] { "ClientId", "IsUsed", "ExpiresAt" });

            migrationBuilder.CreateIndex(
                name: "IX_ClientPasswordResetTokens_TokenHash",
                table: "ClientPasswordResetTokens",
                column: "TokenHash");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokens_OwnerId_UserType_DeviceId",
                table: "RefreshTokens",
                columns: new[] { "OwnerId", "UserType", "DeviceId" });
